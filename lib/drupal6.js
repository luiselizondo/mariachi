...
function Drupal6(project) {
	...
	console.log("information about the project");
...
Drupal6.prototype.deploy = function(callback) {
	...
	self.MySQLcreateDatabase(function(err, stdout, stderr) {
		self.MySQLcreateUser(function(err, stdout, stderr) {
...
Drupal6.prototype.MySQLcreateDatabase = function(callback) {
	...
	console.log("databaseUserRoot: %s", self.databaseUserRoot);
	console.log("databasePasswordRoot: %s",  self.databasePasswordRoot);
