 ...
 * Sites
 */
Connection.prototype.getSite = function(id, callback) {
...
Connection.prototype.getSites = function(callback) {
...
Connection.prototype.saveSite = function(data, callback) {
	var query = "INSERT INTO sites SET ?";
 	connection.query(query, data, function(err, rows, fields) {
 		callback(err, rows);
 	});
}

Connection.prototype.updateSite = function(id, data, callback) {
	var query = "UPDATE sites SET ? WHERE id = ?";
	connection.query(query, [data, id], function(err, rows, fields) {
		callback(err, rows);
	});
}

Connection.prototype.deleteSite = function(id, callback) {
